...
public class TestCapNhatNhanVien {
	...
	public Object[] getData1(int i) throws Exception {
		excel.setExcelFile("data/TestData.xlsx", "UpdateNhanVien");
	...
	public void testThemNhanVien(String maNV,String tenNV,String sdt,String diaChi,String cmnd,boolean gioiTinh,String maChucVu,String
		...
		Assert.assertEquals(result, dao.checkCapNhatNhanVien( maNV, tenNV, sdt, diaChi, cmnd, gioiTinh, maChucVu, gmail, path));
	}
