...
public class TestThemNhanVien {
	...
	private Object[][] data() {
		return new Object[][] { 
				{ getForm1().getMaNV(),getForm1().getSoDienThoai(),getForm1(),"Thêm thất bại!"}, 
				{ getForm1().getMaNV(),getForm1().getSoDienThoai(),getForm1(),"Thêm thất bại!"},
				{ getForm1().getMaNV(),getForm1().getSoDienThoai(),getForm1(),"Thêm thành công!"}, };
	}
	public NhanVien getForm1() {
        NhanVien nv = new NhanVien();
        nv.setMaNV("1");
        nv.setTenNV("Lê Văn Thành");
        nv.setGioiTinh(true);
	...
	public void testThemNhanVien(String manv,String sdt,NhanVien nv, String result) {
		Assert.assertEquals(result, dao.checkThemNhanVien(manv,sdt,nv));
	}
